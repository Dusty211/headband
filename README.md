...
### Forked From: FastAPI MCP LangGraph Template by Nicholas Goh
...
This project is licensed under the terms of the "All Rights Reserved" license. See the `LICENSE` file for more details.

The original boilerplate code for this project was based on the `fastapi-mcp-langgraph-template` by Nicholas Goh, which is licensed under the MIT license. A copy of the MIT license is included in the `LICENSE.MIT` file.
